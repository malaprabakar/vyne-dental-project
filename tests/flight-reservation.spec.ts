import { test, chromium, expect, request, Browser, Page } from '@playwright/test';

test.describe('American Airlines Booking Flow with API Validation and Reporting', () => {
    let browser: Browser;
    let context;
    let page: Page;
    ...
    test('Step 1: Navigate to American Airlines', async () => {
    ...
    test('Step 2: Select One Way Option', async () => {
    ...
    test('Step 3: Enter Origin and Destination', async () => {
    ...
    test('Step 4: Enter Departure Date', async () => {
    ...
    test('Step 5: Submit Flight Search', async () => {
    ...
    test('Step 6: Verify and Capture Flight Results', async ({ request }) => {
        console.log('Waiting for search results to load...');
        await page.waitForTimeout(20000);
        await page.waitForLoadState('networkidle');

        const resultsCountSpan = page.locator('span.result-count');
        await expect(resultsCountSpan).toBeVisible({ timeout: 20000 });
